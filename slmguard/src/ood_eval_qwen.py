...
DEVICE = 'cuda'
CKPT = '/data/ishita_workspace/SLM-GAURD/slmguard/checkpoints/slmguard-qwen25-lora'
...
print("=== Qwen2.5-1.5B + LoRA OOD Evaluation ===")
...
evaluate_file(f'{BASE}/advbench.jsonl',           'AdvBench (520 harmful)')
