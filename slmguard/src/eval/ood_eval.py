...
from model.config import DEPLOY_CKPT
...
def evaluate_file(path, name, threshold=0.4):
    ...
    for ex in examples:
        ...
        labels.append(int(ex['harm_label']))
...
BASE = '/data/ishita_workspace/SLM-GAURD/slmguard/data/ood_judged'
evaluate_file(f'{BASE}/alpacaeval_benign.jsonl', 'AlpacaEval (805, mostly benign)')
...
evaluate_file(f'{BASE}/advbench.jsonl',           'HarmfulQA (520 prompts)')
