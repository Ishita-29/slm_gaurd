...
DEPLOY_CKPT = "/data/ishita_workspace/SLM-GAURD/slmguard/checkpoints/slmguard-deploy-alpha085"
...
GENERATION_SYSTEM_PROMPT = """You are a dataset generation assistant for research.
