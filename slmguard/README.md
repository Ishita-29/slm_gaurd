...
Claude (web interface, claude.ai) was used during this project for:
- Assistance generating and reviewing synthetic SE-Bench examples
- Thesis writing assistance and review

All code was reviewed, tested, and verified to produce the reported results.
All experimental results were produced by running the code on local GPU infrastructure.
